...
INSERT INTO `categoriadaempresa` VALUES (1,'Tecnologia da Informação','Soluções inovadoras para empresas que querem crescer com tecnologia',0,1,1);
...
INSERT INTO `categoriaitem` VALUES (1,'BEBIDA'),(2,' Entradas'),(3,'Pratos Principais'),(4,'Acompanhamentos'),(5,'Sobremesas');
...
INSERT INTO `contato` VALUES (1,0,1,'');
...
INSERT INTO `estado` VALUES (1,'Acre','AC',1),(2,'Alagoas','AL',1),(3,'Amazonas','AM',1),(4,'Bahia','BA',1),(5,'Ceará','CE',1),(6,'Espírito Santo','ES',1),(7,'Goiás','GO',1),(8,'Maranhão','MA',1),(9,'Mato Grosso','MT',1),(10,'Mato Grosso do Sul','MS',1),(11,'Minas Gerais','MG',1),(12,'Pará','PA',1),(13,'Paraíba','PB',1),(14,'Paraná','PR',1),(15,'Pernambuco','PE',1),(16,'Piauí','PI',1),(17,'Rio de Janeiro','RJ',1),(18,'Rio Grande do Norte','RN',1),(19,'Rio Grande do Sul','RS',1),(20,'Rondônia','RO',1),(21,'Roraima','RR',1),(22,'Santa Catarina','SC',1),(23,'São Paulo','SP',1),(24,'Sergipe','SE',1),(25,'Tocantins','TO',1);
...
--
-- Dumping data for table `permissaomembrogrupo`
--

LOCK TABLES `permissaomembrogrupo` WRITE;
/*!40000 ALTER TABLE `permissaomembrogrupo` DISABLE KEYS */;
/*!40000 ALTER TABLE `permissaomembrogrupo` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `reserva_item` VALUES (1,'refrigerante','2','com limão','pendente',1);
...
INSERT INTO `tipodecontato` VALUES (1,'Telefone');
