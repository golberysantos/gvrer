...
public class JuridicaRepository {
    ...
    public int cadastrar(JuridicaDTO juridicaDTO) throws Exception {
        ...
        try {
            ...
            long tipocontatoId;
            String insertTipoContato = "INSERT INTO tipodecontato (nometipocontato, pessoaid) VALUES (?, ?)";
            ...
            stmtTipoContato.setLong(2, pessoa.getPessoaid());
            ...
            // Inserir contato
            String insertContato = "INSERT INTO contato (contato, pessoaid, tipocontatoid) VALUES (?, ?, ?)";
            PreparedStatement stmtContato = cnctn.prepareStatement(insertContato);
            stmtContato.setString(1, juridicaDTO.getContato());
            stmtContato.setLong(2, pessoa.getPessoaid());
            stmtContato.setLong(3, tipocontatoId);
