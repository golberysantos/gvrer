 ...
 * following: - execute: Returns true if the first object that the query returns
 * is a ResultSet object. Use this method if the query could return one or more
 * ResultSet objects. Retrieve the ResultSet objects returned from the query by
 * repeatedly calling Statement.getResultSet. - executeQuery: Returns one
 * ResultSet object. - executeUpdate: Returns an integer representing the number
